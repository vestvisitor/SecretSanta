...
Когда-то давно я разработал чат-бота для игры в "Тайного Санту" с друзьями (которго, кстати, не так довно [обновил](https://github.com/vestvisitor/SecretSantaBot)), но в процессе его эксплуатации я столкнулися с несколькими проблемами:
